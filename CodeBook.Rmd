...
assumption that the file is downloaded exactly from the link provided for this project and that 
this file is unzipped in the current directory. Also, I assign meaningful names to the variables 
