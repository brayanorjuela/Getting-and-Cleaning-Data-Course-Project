...
proceed to make the downloads folder my current directory and to read herein the files needed for my final data set. This can Also, I assign meaningful names to the variables present in the previously mentioned files 
